...
name: documenter
description: >
  Documents source code using the Wynxx MCP Server. Use this skill whenever the user
  asks to document a file or code snippet. Generates documentation in Markdown
